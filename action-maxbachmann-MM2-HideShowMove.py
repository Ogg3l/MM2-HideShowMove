...
if __name__ == "__main__":
    ...
    mqtt_client.message_callback_add("hermes/intent/Oggel:MM_Hide/#", message)
    mqtt_client.message_callback_add("hermes/intent/Oggel:MM_Show/#", message)
    mqtt_client.message_callback_add("hermes/intent/Oggel:MM_Move/#", message)
